...
An application that interfaces with the user via the CLI - prompt the user with a menu:
...
TASKS AND USER APPLICATION
TASK URL: "http://demo.codingnomads.co:8080/tasks_api/tasks"
USER URL: "http://demo.codingnomads.co:8080/tasks_api/users"
